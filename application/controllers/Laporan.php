...
class Laporan extends CI_Controller
{
    ...
    function inventaris()
    {
        ...
        // mencetak string 
        $pdf->Cell(10, 14, '', 0, 1);
        $pdf->Cell(270, 5, 'LAPORAN ASET INVENTARIS', 0, 1, 'C');
    ...
    function pembelian()
    {
        ...
        // mencetak string 
        $pdf->Cell(10, 14, '', 0, 1);
        $pdf->Cell(270, 5, 'LAPORAN PEMBELIAN BARANG', 0, 1, 'C');
    ...
    function pinjam_barang()
    {
        ...
        $pdf->SetCreator(PDF_CREATOR);
        $pdf->SetAuthor('Anonim');
        $pdf->SetTitle('Laporan Barang (Peminjaman)');
        $pdf->SetSubject('Laporan');
        ...
        // mencetak string 
        $pdf->Cell(10, 14, '', 0, 1);
        $pdf->Cell(270, 5, 'LAPORAN DATA BARANG PEMINJAMAN', 0, 1, 'C');
    ...
    function peminjaman()
    {
        ...
        // mencetak string 
        $pdf->Cell(10, 14, '', 0, 1);
        $pdf->Cell(270, 5, 'LAPORAN PEMINJAMAN ASET', 0, 1, 'C');
